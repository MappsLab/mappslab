 ...
 */
        ...
        /**
         * *** Controls ****Options for the rendering of the map type control. 
         */
            ...
            opened?: boolean
             ...
             export type GestureHandlingOptions = "NO PRINT IMPLEMENTED: LiteralType" | "NO PRINT IMPLEMENTED: LiteralType" | "NO PRINT IMPLEMENTED: LiteralType" | "NO PRINT IMPLEMENTED: LiteralType";
        ...
        declare type DrawingMode = 'Point' | 'LineString' | 'Polygon';
        declare module 'Data' {
         ...
         * *** Overlays ****
         */
        export class Marker mixins MVCObject {
            MAX_ZINDEX: number;
         ...
         */
        export class InfoWindow mixins MVCObject {
        ...
        export class Polyline mixins MVCObject {
        ...
        export class Polygon mixins MVCObject {
        ...
        export class Rectangle mixins MVCObject {
         ...
         */
        export class Circle mixins MVCObject {
        ...
        export class GroundOverlay mixins MVCObject {
            constructor(url: string, bounds: LatLngBounds | LatLngBoundsLiteral, opts?: GroundOverlayOptions): this;
            getBounds(): LatLngBounds;
            getMap(): Map;
            getOpacity(): number;
            getUrl(): string;
        ...
        export class OverlayView mixins MVCObject {
            draw(): void;
            getMap(): Map | StreetViewPanorama;
            getPanes(): MapPanes;
        ...
        export class MapCanvasProjection mixins MVCObject {
        ...
        export class DirectionsRenderer mixins MVCObject {
        ...
        */
        ...
        export class MapTypeRegistry mixins MVCObject {
            constructor(): this;
        ...
        export class ImageMapType mixins MVCObject, MapType {
        ...
        export class StyledMapType mixins MVCObject, MapType {
        ...
        export type MapTypeStyleFeatureType = "NO PRINT IMPLEMENTED: LiteralType" |
            ...
            "NO PRINT IMPLEMENTED: LiteralType" |
            "NO PRINT IMPLEMENTED: LiteralType";
        export type MapTypeStyleElementType = "NO PRINT IMPLEMENTED: LiteralType" |
            "NO PRINT IMPLEMENTED: LiteralType" |
            "NO PRINT IMPLEMENTED: LiteralType" |
            "NO PRINT IMPLEMENTED: LiteralType" |
            "NO PRINT IMPLEMENTED: LiteralType" |
         ...
         * *** Layers ****
         */
        export class BicyclingLayer mixins MVCObject {
            constructor(): this;
            getMap(): Map;
            setMap(map: Map | null): void
        }
        export class FusionTablesLayer mixins MVCObject {
        ...
        export class KmlLayer mixins MVCObject {
        ...
        export class TrafficLayer mixins MVCObject {
            constructor(opts?: TrafficLayerOptions): this;
            getMap(): Map;
            setMap(map: Map | null): void;
        ...
        export class TransitLayer mixins MVCObject {
            constructor(): this;
            getMap(): void;
            setMap(map: Map | null): void
        }
         ...
         * *** Street View ****
         */
        export class StreetViewPanorama mixins MVCObject {
        ...
        export interface StreetViewPanoramaOptions {
            addressControl?: boolean,
                ...
                mode?: "NO PRINT IMPLEMENTED: LiteralType" | "NO PRINT IMPLEMENTED: LiteralType" | "NO PRINT IMPLEMENTED: LiteralType",
                panControl?: boolean,
                panControlOptions?: PanControlOptions,
                pano?: string,
        ...
        export class StreetViewCoverageLayer mixins MVCObject {
            getMap(): Map;
            setMap(map: Map | null): void
        }
        ...
        */
        ...
        /**
         * *** MVC ****Base class implementing KVO. 
         */
         ...
         * This class extends MVCObject. 
         */
        export class MVCArray<T>mixins MVCObject {
        ...
        declare module 'geometry' {
            ...
            export class spherical {
                ...
                */
                computeArea(path: LatLng[] | MVCArray<LatLng>, radius?: number): number;
                ...
                */
                 ...
                 */
                computeLength(path: LatLng[] | MVCArray<LatLng>, radius?: number): number;
                ...
                */
                ...
                square meters.
                */
                computeSignedArea(loop: LatLng[] | MVCArray<LatLng>, radius?: number): number;
        ...
        declare module 'adsense' {
            export class AdUnit mixins MVCObject {
        ...
        declare module 'places' {
            export class Autocomplete mixins MVCObject {
            ...
            export type LocationBias = LatLng |
                LatLngLiteral |
                LatLngBounds |
                LatLngBoundsLiteral |
                Circle |
            ...
            export class SearchBox mixins MVCObject {
        ...
        declare module 'drawing' {
            export class DrawingManager mixins MVCObject {
        ...
        declare module 'visualization' {
            export class MapsEngineLayer mixins MVCObject {
                ...
                featureId?: string,
                    ...
                    pixelOffset?: Size
                     ...
                     export class HeatmapLayer mixins MVCObject {
                constructor(opts?: HeatmapLayerOptions): this;
                getData<T>(): MVCArray<T>;
                getMap(): Map;
                setData(
                    data: MVCArray<LatLng | WeightedLocation>| LatLng[] | WeightedLocation[]): void;
                setMap(map: Map | null): void
            }
