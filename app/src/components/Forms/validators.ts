...
export const composeValidators = (
	...validators: Array<ValidatorFunction | Array<ValidatorFunction>>
): ValidatorFunction => (
	value: string | void,
...
export const required = (value: string | void) =>
...
export const minValue = (min: number) =>
	composeValidators(mustBeNumber, (value: number) =>
		value >= min ? undefined : `Should be at least ${min}`,
	)

export const maxValue = (min: number) =>
	composeValidators(mustBeNumber, (value: number) =>
		value <= min ? undefined : `Should be no more than ${min}`,
	)
...
export const alphaNumDash = (value: string) =>
	!value || alphaNumDashRegex.test(value)
		? undefined
		: 'May only be letters, numbers, and hyphens'
export const noUpperCase = (value: string) =>
	!value || noUpperCaseRegex.test(value) ? undefined : 'Must be all lower case'
export const noDoubleDash = (value: string) =>
	!value || noDoubleDashRegex.test(value)
		? undefined
		: 'May not contain sequential hyphens'
export const startEndAlphaNum = (value: string) =>
	!value || startEndAlphaNumRegex.test(value)
		? undefined
...
export const validUsername = composeValidators(
	minMaxLength(5, 25),
	alphaNumDash,
	noUpperCase,
	noDoubleDash,
...
export const emailValidators = composeValidators(
	required,
	email,
	maxLength(128),
)
export const usernameValidators = composeValidators(
	required,
	maxLength(24),
	validUsername,
)
