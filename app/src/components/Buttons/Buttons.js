...
export const ButtonWrapper = styled.button`
	${({ theme, level, disabled }) => css`
		...
		font-weight: ${
			level === 'primary' ? theme.font.weight.semi : theme.font.weight.normal
		};
		...
		border: ${
			level === 'secondary' ? `1px solid ${theme.color.primary.normal}` : ''
		};
		transition: 0.1s;
		${disabled &&
			`
...
export const SubmitButton = (props: SubmitButtonProps) => (
	<ButtonWrapper {...props} type="submit" level="primary" />
)
